...
FORCE_SUB_CHANNELS = [int(fsub_channels) if fsub_channels.startswith("-") else fsub_channels for fsub_channels in environ.get('FORCE_SUB_CHANNELS', '-1002303403489').split()]
if len(FORCE_SUB_CHANNELS) == 0:
    print('Info - FORCE_SUB_CHANNELS is empty')
    
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002361463120')
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/+jTXHfhorBUJiMWU1')
OWNER_USERNAME = environ.get("OWNER_USERNAME", "https://t.me/dillubot_bot")
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/BEST_NEWW')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/moviedillu')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/LINKKHOLNE")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/LINKKHOLNE")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/rf.jpg')
if len(PAYMENT_QR) == 0:
    print('Info - PAYMENT_QR is empty')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'BOT IS FREE')  #if you not have UPI, then use another method
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002303403489")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/BEST_NEWW")
if len(URL) == 0:
