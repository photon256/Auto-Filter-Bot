...
# Bot information
API_ID = environ.get('API_ID', '16253557')
if len(API_ID) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002205282436')
if len(LOG_CHANNEL) == 0:
    logger.error('LOG_CHANNEL is missing, exiting now')
    exit()
else:
    LOG_CHANNEL = int(LOG_CHANNEL)
FORCE_SUB_CHANNELS = [int(fsub_channels) for fsub_channels in environ.get('FORCE_SUB_CHANNELS', '-1002303403489').split()]
if len(FORCE_SUB_CHANNELS) == 0:
    logger.info('FORCE_SUB_CHANNELS is empty')
    
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002302335280')
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "mongodb+srv://abcd:abcdeas@cluster0.a1k66.mongodb.net/?retryWrites=true&w=majority")
if len(DATA_DATABASE_URL) == 0:
    logger.error('DATA_DATABASE_URL is missing, exiting now')
    exit()
FILES_DATABASE_URL = environ.get('FILES_DATABASE_URL', "mongodb+srv://abcd:abcdeas@cluster0.a1k66.mongodb.net/?retryWrites=true&w=majority")
if len(FILES_DATABASE_URL) == 0:
    logger.error('FILES_DATABASE_URL is missing, exiting now')
    exit()
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', "mongodb+srv://abcd:abcdeas@cluster0.a1k66.mongodb.net/?retryWrites=true&w=majority")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/BEST_NEWW')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/BEST_NEWW')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/BEST_NEWW')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/BEST_NEWW")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/BEST_NEWW")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002205282436")
if len(BIN_CHANNEL) == 0:
    logger.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/+q8U0kv-yZ2YwM2M1")
if len(URL) == 0:
